...
def runProcess(language):
    ...
    # xml_data = getData(r'G:\Nomenclature\Article.Nomenclature\binder\nomenclature\xml\\' + language + '_product1.xml')
    xml_data = getData('xml/' + language + '_product1.xml')
    ...
    print('Number of disorders with a definition in ' + dict_language[language] + ' : ' + str(len(disordersWithDefinition)))
    print('Percentage of disorders with a definition in ' + dict_language[language] + ' : ' + str(round((n_disordersWithDefinition / n_disorders)*100, 2)))
